...
class ConfigFileSoilAdapter(SoilDataAdapter):
    ...
    def __init__(self, config_path: str | None = None, enabled: bool = True):
        """
        ...
        self.config_path = config_path or os.path.join(
            os.path.dirname(__file__), "../config/soil_parameters.json"
        )
    ...
    def get_data(self, field_id: str, **kwargs) -> dict[str, Any]:
        ...
        try:
            ...
            if field_params:
                ...
                logger.warning(f"No soil parameters found for field {field_id}, using fallback")
                return self.get_fallback_data(field_id=field_id)
    ...
    def get_fallback_data(self, field_id: str = None, **kwargs) -> dict[str, Any]:
        ...
        """
        logger.info("Using default soil parameters", field_id=field_id)
