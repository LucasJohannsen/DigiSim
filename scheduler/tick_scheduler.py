...
class TickScheduler:
        ...
        for context in contexts:
            ...
            if snapshot:
                ...
                logger.info(
                    ...
                    last_tick_date=str(snapshot.last_tick_date),
                )
    ...
    async def daily_tick(self) -> None:
        ...
        logger.info(
            "Heartbeat written", path=str(heartbeat_path), successful=successful, total=total
        )
    ...
    def start(self) -> None:
        ...
        self._running = True
        logger.info(
            "TickScheduler started",
            field_count=len(self.runners),
            tick_time=self.tick_time,
            max_concurrent=self.max_concurrent_fields,
        )
