...
class TestDailyTickEvents(unittest.TestCase):
    ...
    def test_create_daily_tick_started(self):
        ...
        event = create_daily_tick_started(field_id="field-1", date=test_date)
    ...
    def test_create_daily_tick_completed(self):
        ...
        test_date = datetime(2026, 3, 20, 0, 0, 0)
        event = create_daily_tick_completed(field_id="field-2", date=test_date, events_dispatched=5)
    ...
    def test_daily_tick_events_serialization(self):
        ...
        event = create_daily_tick_started(field_id="field-3", date=datetime(2026, 3, 20))
...
class TestCropCycleEvents(unittest.TestCase):
    ...
    def test_create_crop_cycle_started(self):
        ...
        event = create_crop_cycle_started(field_id="field-1", date=test_date, crop_type="Kartoffel")
    ...
    def test_create_harvest_completed(self):
        ...
        event = create_harvest_completed(field_id="field-2", date=test_date, yield_estimate=45.5)
    ...
    def test_harvest_completed_without_yield(self):
        ...
        event = create_harvest_completed(field_id="field-3", date=datetime(2026, 9, 20))
...
class TestOperationEvents(unittest.TestCase):
    ...
    def test_create_operation_considered(self):
        ...
        event = create_operation_considered(
            field_id="field-1", date=test_date, operation_type="Pflügen", worktype=1
        )
    ...
    def test_create_operation_approved(self):
        ...
        event = create_operation_approved(
            field_id="field-2", date=test_date, operation_type="Düngen", worktype=3
        )
    ...
    def test_operation_applied_without_integration_event(self):
        ...
        event = create_operation_applied(
            field_id="field-5", date=datetime(2026, 5, 10), operation_type="Test", worktype=1
        )
