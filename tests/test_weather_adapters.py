...
from services.weather_adapters import DWDWeatherAdapter, OpenMeteoWeatherAdapter
...
class TestOpenMeteoWeatherAdapter:
    ...
    def test_adapter_disabled(self):
        ...
        adapter = OpenMeteoWeatherAdapter(latitude=52.52, longitude=13.41, enabled=False)
    ...
    def test_fallback_data_seasonal_variation(self):
        ...
        summer_data = adapter.get_fallback_data(
            start_date=datetime.date(2024, 7, 1), end_date=datetime.date(2024, 7, 31)
        )
    ...
    def test_error_handling_fallback(self, mock_get):
        ...
        data = adapter.get_data(
            start_date=datetime.date(2024, 1, 1), end_date=datetime.date(2024, 1, 10)
        )
