...
class TestFastForwardRunner:
    ...
    def test_fast_forward_initialization(self, sim_context, event_bus):
        ...
        runner = FastForwardRunner(context=sim_context, n_days=30, event_bus=event_bus)
    ...
    def test_fast_forward_30_days(self, sim_context):
        ...
        runner = FastForwardRunner(context=sim_context, n_days=30, output_target="stdout")
    ...
    def test_fast_forward_full_season(self, sim_context):
        ...
        runner = FastForwardRunner(context=sim_context, n_days=365, output_target="stdout")
    ...
    def test_fast_forward_json_export(self, sim_context, tmp_path):
        ...
        runner = FastForwardRunner(
            context=sim_context, n_days=30, output_target="json", output_path=str(output_path)
        )
    ...
    def test_fast_forward_memory_bounded(self, sim_context):
        ...
        runner = FastForwardRunner(
            context=sim_context, n_days=100, output_target="stdout", flush_interval=10
        )
    ...
    def test_fast_forward_progress_reporting(self, sim_context, capsys):
        ...
        runner = FastForwardRunner(context=sim_context, n_days=60, output_target="stdout")
