...
class TestIrrigationCandidatePipeline:
    ...
    def test_irrigation_candidates_are_generated_in_crop_management_phase(self, sim_context, mock_moisture_data_dry):
        ...
        with patch('scheduler.calendar_driven_runner.MoistureDataService') as MockMoistureService:
            ...
            with patch.object(runner.irrigation_service, 'get_candidate_operations') as mock_get_candidates:
    ...
    def test_irrigation_side_effects_are_applied_when_candidate_selected(self, sim_context, mock_moisture_data_dry):
        ...
        with patch('scheduler.calendar_driven_runner.MoistureDataService') as MockMoistureService:
            ...
            if irrigation_events:
                ...
                assert runner.irrigation_service.irrigation[day_of_year] != initial_irrigation[day_of_year]


class TestUnifiedDecisionPipeline:
    """Test that all operation types go through the same decision pipeline"""
    
    def test_irrigation_candidates_compete_with_other_operations(self, sim_context, mock_moisture_data_dry):
    ...
    def test_irrigation_events_logged_same_as_other_events(self, sim_context, mock_moisture_data_dry):
...
class TestErrorHandling:
    ...
    def test_irrigation_execution_error_handled_gracefully(self, sim_context, mock_moisture_data_dry):
